...
declare -A IMAGE_NAMES=(
  ["auth-service"]="mini-node-auth"
  ["api-service"]="mini-node-api"
  ["audit-service"]="mini-node-audit"
  ["mailer-service"]="mini-node-mailer"
  ["notification-service"]="mini-node-notification"
  ["gateway"]="mini-node-gateway"
)
...
if [[ "${INCLUDE_FRONTEND_IMAGE}" == "true" ]]; then
  ...
  IMAGE_NAMES["frontend"]="mini-node-web"
